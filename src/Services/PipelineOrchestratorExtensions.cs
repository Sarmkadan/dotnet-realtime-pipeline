...
public static class PipelineOrchestratorExtensions
{
	...
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="orchestrator"/> is <c>null</c>.</exception>
	/// <exception cref="ArgumentException">Thrown when <paramref name="dataPoints"/> is <c>null</c> or empty.</exception>
		...
		IEnumerable<DataPoint> dataPoints)
	{
		...
		if (!dataPoints.Any())
			throw new ArgumentException("Data points collection cannot be empty", nameof(dataPoints));
