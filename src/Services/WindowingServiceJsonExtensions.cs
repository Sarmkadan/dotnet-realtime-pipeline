...
public static class WindowingServiceJsonExtensions
{
    ...
    /// <returns>The deserialized windowing service instance, or <see langword="null"/> if the JSON is empty.</returns>
    ...
    public static WindowingService? FromJson(string json)
    {
        ...
        return JsonSerializer.Deserialize<WindowingService>(json, _jsonOptions);
    }
