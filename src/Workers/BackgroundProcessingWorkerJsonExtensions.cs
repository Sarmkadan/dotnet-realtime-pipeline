...
/// <summary>
/// Provides System.Text.Json serialization helpers for <see cref="BackgroundProcessingWorker"/> and related worker types.
/// </summary>
public static class BackgroundProcessingWorkerJsonExtensions
{
 ...
 public static bool TryFromJson(string json, [NotNullWhen(true)] out BackgroundProcessingWorker? value)
 {
