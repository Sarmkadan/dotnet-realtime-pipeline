...
public static class ScalingDecisionExtensions
{
    ...
    {
        ArgumentNullException.ThrowIfNull(decision);
        ArgumentException.ThrowIfNullOrEmpty(decision.StageName, nameof(decision.StageName));
        ArgumentException.ThrowIfNullOrEmpty(decision.Reason, nameof(decision.Reason));
    ...
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="decision"/> is <c>null</c>.</exception>
    /// <exception cref="ArgumentException">Thrown if <paramref name="decision.StageName"/> is null or whitespace.</exception>
