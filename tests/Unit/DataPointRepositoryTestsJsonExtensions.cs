...
public static class DataPointRepositoryTestsJsonExtensions
{
    ...
    /// <summary>
    /// Serializes a <see cref="DataPointRepositoryTests"/> instance to a JSON string using camelCase property naming.
    /// </summary>
    ...
    /// <returns>The deserialized test instance.</returns>
