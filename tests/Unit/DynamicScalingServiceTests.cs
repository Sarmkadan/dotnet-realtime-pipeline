...
/// <summary>
/// Unit tests for the <see cref="DynamicScalingService"/> class.
/// Tests the dynamic scaling functionality that adjusts the number of consumers
/// based on backpressure metrics to optimize pipeline performance.
/// </summary>
