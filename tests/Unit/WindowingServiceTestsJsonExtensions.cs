...
public sealed class WindowingServiceTestsJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="WindowingServiceTests"/> instance to a JSON string.
    /// </summary>
    ...
    public static WindowingServiceTests? FromJson(string json)
    {
        ...
        return JsonSerializer.Deserialize<WindowingServiceTests>(json, _jsonOptions);
    }

    /// <summary>
    /// Attempts to deserialize a JSON string to a <see cref="WindowingServiceTests"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    ...
    public static bool TryFromJson(string json, out WindowingServiceTests? value)
    {
        ...
        try
        {
            value = JsonSerializer.Deserialize<WindowingServiceTests>(json, _jsonOptions);
            return true;
        }
        catch (JsonException)
        {
